...
operated from the [command line interface](/docs/walrus-client/storing-blobs), a [JSON API](/docs/walrus-client/json-mode), and an [HTTP API](/docs/http-api/storing-blobs). We also offer the community an aggregator and
