...
- Find out how to
  [upload and delete deletable blobs](/docs/walrus-client/storing-blobs#reclaiming-space-via-deletable-blobs)
  through the CLI.
- Find out more about how [delete operations work](/docs/system-overview/operations#delete).
...
- Find out the [current epoch](/docs/walrus-client/storing-blobs#walrus-system-information) through the CLI.
- Find out how to store a blob for
  [multiple epochs](/docs/walrus-client/storing-blobs).
...
Find out how to [request Testnet WAL tokens](/docs/system-overview/available-networks#testnet-wal-faucet) through the CLI.
